...
public class TrampolineSkipCellsByRolledNumberPlugin implements PluginCommand {
	...
	public Object execute(ActionEntity action) {
		...
		int rolledNumber = this.random.nextInt(6) + 1; // 1 - 6
		
		double updatedCellNr = initialCellNr + rolledNumber;
